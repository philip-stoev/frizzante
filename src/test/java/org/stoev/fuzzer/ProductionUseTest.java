...
public class ProductionUseTest {
	...
	public final void testOneProduction() {
		...
		Assert.assertEquals(productionUsed.getEnd(), 1 + 2);
		Assert.assertTrue(!i.hasNext());
	...
	public final void testTwoProductions() {
		...
		Assert.assertEquals(productionUsed1.getEnd(), 7);
		...
		Assert.assertEquals(productionUsed2.getEnd(), 3);
		...
		Assert.assertEquals(productionUsed3.getEnd(), 7);
